"""Программа которая вычисляет индекс массы тела в зависимости от роста, веса и возраста, а затем выдает результат в соответствии с рекомендациями Всемирной Организации Здравоохранения."""
...
if 10 < age or age > 100 or height <= 0 or height > 3 or weight <= 0 or weight > 500:    
